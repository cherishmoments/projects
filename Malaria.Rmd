...
top_fig = top_fig %>% colorbar(title ="Incidence") %>% layout(title="Top 5 highest incidence (per 1,000 population at risk) (2010)")
top_fig
...
Observation: It could be observed that Turkey with the highest incidence in 2010, had a sharp decrease in the incidence in 2005 and continued to have a delicing incidence over the years. Ethiopia as well. 

Remarks:
- If more information such as the demographics of the people who are affected by malaria, such as age, we are able to see which age group is/are more affected by the malaria.
